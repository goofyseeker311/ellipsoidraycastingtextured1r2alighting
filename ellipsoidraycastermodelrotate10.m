...
wimagefiles={"physical-world-map.jpg","Fondvulcain.jpg","world116cE.jpg", "galaxy2.jpg", "skygalaxy-hdri-114148912.jpg", "voie-lactee-hd-eso-l3.jpg"};
...
nspheres = 100; scenespheres = [100*(rand(nspheres,3)-0.5) 6*rand(nspheres,1)+4 2*rand(nspheres,3)+0.5 ones(nspheres,3) randi(wimagescount,nspheres,1)]; #randi(255,nspheres,3)/255
...
spherebufferwidth = 3*3840; spherebufferheight = 3*1080; numbytes = 4;
